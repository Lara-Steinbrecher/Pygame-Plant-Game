...
class Needs_Paper():
    def __init__(self, screen, font, escale_img):
        ...
        self.background = pygame.Surface((250,300))
    ...
    def run(self, water, light, temp, soil):
        ...
        self.needs_text = self.font.render("Necesidades", True, (255, 255, 255))
        self.agua_text = self.font.render(f"Agua: {self.water_need}", True, (255, 255, 255))
        self.luz_text = self.font.render(f"Luz: {self.light_need}", True, (255, 255, 255))
        self.soil_text = self.font.render(f"Tierra: {self.soil_need}", True, (255, 255, 255))
        self.temp_text = self.font.render(f"Temperatura: {self.temp_need}", True, (255, 255, 255))

        self.screen.blit(self.needs_text, (c.ANCHO // 2 - 50, c.ALTO // 2 - 120))
